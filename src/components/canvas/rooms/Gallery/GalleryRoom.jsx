...
const UNIQUE_PROJECTS = [
    {
        ...
        description: 'An AI-powered system designed to analyze agricultural lands, assess crop damage using drone data or satellite imagery, and automate claim processing for crop insurance, securing farming livelihoods.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/firebaselogo.webp']
    },
    {
        id: 'neuro-grid',
        title: 'NEURO GRID',
        ...
        url: 'https://github.com/Madhan06-S',
        description: 'An interactive neural network visualization and exploration interface, demonstrating how neural layers, weights, and node activations interact during training and inference.',
    ...
    },
    {
        ...
        url: 'https://github.com/Madhan06-S',
        description: 'An advanced personal voice assistant powered by Large Language Models, integrating text-to-speech, speech-to-text, and local tool executions to streamline daily tasks.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/firebaselogo.webp']
    },
    {
        id: 'covai-cars',
        title: 'COVAICARS',
        ...
        url: 'https://github.com/Madhan06-S',
        description: 'A modern, user-friendly car rental and management web platform allowing users to seamlessly browse, book, and review vehicle rentals with an integrated payment flow.',
    ...
    },
    {
        ...
        title: 'SMART SCHOOL MGMT',
        front: '/textures/gallery/monetuneprzod.webp',
        painted: '/textures/gallery/monetuneprzod_painted.webp',
        url: 'https://github.com/Madhan06-S',
        description: 'A comprehensive institutional administration dashboard featuring attendance tracking, fee management, marks recording, and student-teacher portals.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/firebaselogo.webp']
    },
    {
        id: 'surveillance',
        ...
        painted: '/textures/gallery/timberkittyprzod_painted.webp',
        url: 'https://github.com/Madhan06-S',
        description: 'An intelligent security surveillance application using YOLOv8 for real-time object, human, and anomaly detection with automated alert triggers.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'bird-sound',
        title: 'BIRD SOUND DETECT',
        front: '/textures/gallery/youngmultiprzod.webp',
        painted: '/textures/gallery/youngmultiprzod_painted.webp',
        url: 'https://github.com/Madhan06-S',
        description: 'A deep learning project using convolutional neural networks (CNNs) to classify bird species from audio recordings by analyzing spectrographic data.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/firebaselogo.webp']
    },
    {
        id: 'portfolio',
        ...
        painted: '/textures/gallery/bioprzod_painted.webp',
        url: 'https://github.com/Madhan06-S',
        description: 'An immersive, custom-built 3D WebGL developer portfolio featuring hand-drawn sketch art, spatial audio, and interactive rooms built with React Three Fiber.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/netlifylogo.webp']
    },
];
