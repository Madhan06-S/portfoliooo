...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'MADHAN', subtitle: '< AI Engineer | Full Stack Dev />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'ACHIEVEMENTS', subtitle: '3 Hackathons • 5 Certificates • 3 Internships' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'B.Tech AI & Data Science @ Coimbatore Institute of Technology' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'AI • Web Development • Three.js • Python' },
];
