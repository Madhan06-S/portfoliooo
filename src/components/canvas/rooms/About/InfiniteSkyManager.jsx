...
const AWARDS_DATA = {
    sotd: {
        ...
        items: [
            { label: 'DELTABUILD - Top 10 / 155 Teams', date: '2025', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'FIESTAA GenAI - Participant', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'INTELLIMA - Participant', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' }
        ],
        platformConfig: {
            label: 'HACKATHON',
            color: '#1a1a1a',
    ...
    sotm: {
        ...
        items: [
            { label: 'AI & Data Science Specialist', date: '2025', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'Full Stack Development Certification', date: '2025', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'Machine Learning & Deep Learning', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'UI/UX Design with Figma', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'Google Earth Engine & Spatial Analysis', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' }
        ],
        platformConfig: {
            label: 'CERTIFICATE',
            color: '#1a1a1a',
    ...
    soty: {
        ...
        items: [
            { label: 'CodeAlpha - Full Stack Development Intern', date: '2025', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'El Codamics - Web Developer Intern', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' },
            { label: 'Yuga Yatra Retail - Software Developer Intern', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/Madhan06-S' }
        ],
        platformConfig: {
            label: 'INTERNSHIP',
            color: '#1a1a1a',
...
const BALLOON_CONFIG = [
    ...
    { texture: '/textures/about/csssrednibalon.webp', paintedTexture: '/textures/about/csssrednibalon_painted.webp', label: 'Tailwind CSS', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/textures/about/nextjssrednibalon.webp', paintedTexture: '/textures/about/nextjssrednibalon_painted.webp', label: 'Python / ML', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },

    // Small balloons - background accents
    { texture: '/textures/about/htmlmalybalon.webp', paintedTexture: '/textures/about/htmlmalybalon_painted.webp', label: 'HTML / CSS', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    ...
    { texture: '/textures/about/figmamalybalon.webp', paintedTexture: '/textures/about/figmamalybalon_painted.webp', label: 'UI/UX Figma', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/firebasemalybalon.webp', paintedTexture: '/textures/about/firebasemalybalon_painted.webp', label: 'FastAPI / SQL', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
