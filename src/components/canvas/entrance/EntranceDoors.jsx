...
const EntranceDoors = ({
    ...
    useEffect(() => {
        const wind = play('szumwiatru', { loop: true, volume: 0.25 });
        const birds = play('birds', { loop: true, volume: 0.20 });
    ...
    const handleClick = (e) => {
        ...
        // 1. Depress door handles down on click
        ...
        // 3. Move camera smoothly forward into campus corridor
        ...
        // 4. Trigger corridor music and achievement
        tl.add(() => {
            playBackgroundMusic();
    ...
    return (
        <group ref={groupRef} position={[position[0], 0, position[2]]}>
            ...
            {/* === CINEMATIC LIGHTING === */}
            <ambientLight intensity={1.5} color="#f0f0f0" />
            <directionalLight
                position={[4, 8, 6]}
                intensity={0.8}
                color="#ffffff"
            />
            <pointLight
                position={[0, doorBottomY + doorHeight + 1, 1.2]}
                intensity={0.6}
                color="#fffef0"
                distance={12}
            />
