...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for MADHAN split effect
    const letters = useMemo(() => [
        { char: 'M', baseX: -1.35, splitDir: -2.2, delay: 0 },
        { char: 'A', baseX: -0.81, splitDir: -1.4, delay: 0 },
        { char: 'D', baseX: -0.27, splitDir: -0.6, delay: 0 },
        { char: 'H', baseX: 0.27, splitDir: 0.6, delay: 0 },
        { char: 'A', baseX: 0.81, splitDir: 1.4, delay: 0 },
        { char: 'N', baseX: 1.35, splitDir: 2.2, delay: 0 },
    ], []);
